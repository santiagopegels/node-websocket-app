...
socket.on('actual-state', (payload) => {
    ...
    if (ticket1) {
        ...
        lblEscritorio1.innerText = ticket1.screen

    }
    if (ticket2) {
        lblTicket2.innerText = 'Ticket ' + ticket2.number
        lblEscritorio2.innerText = ticket2.screen

    }
    if (ticket3) {
        lblTicket3.innerText = 'Ticket ' + ticket3.number
        lblEscritorio3.innerText = ticket3.screen

    }
    if (ticket4) {
        lblTicket4.innerText = 'Ticket ' + ticket4.number
        lblEscritorio4.innerText = ticket4.screen
    }
